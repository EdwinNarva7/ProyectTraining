            ...
            <div class="bg-white rounded-[2.5rem] shadow-premium border border-slate-100 overflow-hidden">
                ...
                <div class="p-10 border-b border-slate-100 relative overflow-hidden">
                    ...
                    <div class="flex items-center gap-4 mb-8 relative z-10">
                        ...
                        <div>
                            <h2 class="text-lg font-black text-slate-800 uppercase tracking-tight">Información del Aprendiz</h2>
                            <p class="text-[10px] text-slate-400 font-bold uppercase tracking-widest">Seleccione un aprendiz elegible y confirme sus horas.</p>
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-8 relative z-10">
                        ...
                        <div class="space-y-3">
                            <label for="apprentice_id" class="block text-[10px] font-black text-slate-400 uppercase tracking-[0.2em] ml-1">
                                Seleccionar Aprendiz <span class="text-rose-500">*</span>
                            </label>
                            ...
                            <p class="mt-2 text-[9px] text-slate-400 font-bold uppercase tracking-widest ml-1 italic opacity-60">Solo aprendices con más de 80 horas registradas.</p>
                            @error('apprentice_id')
                ...
                <div class="p-10 bg-slate-50/50 border-b border-slate-100 relative overflow-hidden">
                    ...
                    <div class="flex items-center gap-4 mb-8 relative z-10">
                        ...
                        <div>
                            ...
                            <p class="text-[10px] text-slate-400 font-bold uppercase tracking-widest">Configure cómo el aprendiz recibirá su certificado.</p>
                        </div>
                    </div>
            ...
            <ul class="space-y-5 relative z-10">
                <li class="flex gap-4">
                    ...
                    <p class="text-[10px] font-bold text-slate-400 uppercase tracking-widest leading-relaxed">
                        Cumplimiento mínimo: <span class="text-white">80 horas</span>.
                    </p>
                </li>
                <li class="flex gap-4">
                    <div class="w-1.5 h-1.5 bg-sena rounded-full mt-1.5 flex-shrink-0 shadow-sena shadow-md"></div>
