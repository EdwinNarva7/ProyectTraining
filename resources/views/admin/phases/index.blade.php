                        ...
                        <tr class="group/item hover:bg-slate-50/80 transition-all duration-300">
                            ...
                            <td class="px-8 py-6 text-right">
                                <div class="flex items-center justify-end gap-3">
                                    ...
                                    <form action="{{ route('admin.phases.duplicate', $phase) }}" method="POST" class="inline duplicate-form">
                                        @csrf
                                        <button type="button"
                                            class="w-11 h-11 rounded-2xl bg-slate-50 text-slate-400 hover:bg-indigo-500 hover:text-white transition-all shadow-sm active:scale-90 flex items-center justify-center border border-slate-100 duplicate-btn"
        ...
        document.addEventListener('DOMContentLoaded', function () {
            ...
            document.querySelectorAll('.duplicate-btn').forEach(function (btn) {
                btn.addEventListener('click', function (e) {
                    ...
                    Swal.fire({
                        title: '¿Duplicar fase?',
                        text: "Se creará una copia de esta fase (plantilla) desactivada. Tendrás la oportunidad de cambiar sus fechas y tecnólogos antes de abrirla.",
                        icon: 'info',
                        showCancelButton: true,
