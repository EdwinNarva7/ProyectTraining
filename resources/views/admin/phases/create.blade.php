                    ...
                    <div class="pt-6 border-t border-slate-100">
                        <div class="flex items-center justify-between mb-6">
                            <div>
                                ...
                                <p class="text-[10px] text-slate-400 font-bold uppercase tracking-wider">Añada los programas que pertenecen a esta fase.</p>
                            </div>
                        ...
                        <div id="technologists-container" class="space-y-4">
                            <!-- Template for new technologists -->
                            <div class="technologist-row bg-slate-50/50 p-6 rounded-[1.5rem] border border-slate-100 relative group animate-fadeIn">
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    <div class="space-y-2">
                                        <label class="block text-[9px] font-black text-slate-400 uppercase tracking-widest ml-1">Nombre (ADSO, PAE, etc.)</label>
                                        <input type="text" name="technologists[0][name]" required
