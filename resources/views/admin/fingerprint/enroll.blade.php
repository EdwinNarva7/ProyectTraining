                ...
                <table class="w-full text-left border-collapse" id="apprenticesTable">
                    <thead class="sticky top-0 bg-white z-10 shadow-sm">
                        <tr class="bg-slate-50/80">
                            <th class="px-10 py-5 text-[10px] font-bold text-slate-400 uppercase tracking-widest">Aprendiz</th>
        ...
        <div class="bg-white w-full max-w-md rounded-[3rem] shadow-2xl overflow-hidden animate-zoom-in border border-slate-100">
            ...
            <div class="p-10">
                <div class="text-center mb-8">
                    <p class="text-[9px] font-black text-slate-300 uppercase tracking-[0.4em] mb-2">Aprendiz Seleccionado</p>
