...
@section('title', 'Crear Usuario - SIAP Admin')
    ...
    <div class="mb-8">
        <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
            <div>
                ...
                <p class="text-gray-500 text-sm">Agregue un nuevo usuario al sistema con su rol y permisos</p>
            </div>
            <div>
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="text" name="full_name" id="full_name"
                                ...
                                value="{{ old('full_name') }}" placeholder="e.g. Juan Pérez" required>
                        </div>
                        @error('full_name')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="text" name="job_title" id="job_title"
                                ...
                                value="{{ old('job_title') }}" placeholder="e.g. Practicante, Pasante">
                        </div>
                        @error('job_title')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="email" name="email" id="email"
                                ...
                                value="{{ old('email') }}" placeholder="user@domain.com" required>
                        </div>
                        @error('email')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                            ...
                            <select name="phase_id" id="phase_id"
                                ...
                                @foreach($phases as $phase)
                                    <option value="{{ $phase->id }}" 
                                        {{ (old('phase_id') == $phase->id || (!old('phase_id') && $phase->is_active)) ? 'selected' : '' }}>
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="text" name="document_number" id="document_number"
                                ...
                                value="{{ old('document_number') }}" placeholder="e.g. 1234567890">
                        </div>
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="email" name="personal_email" id="personal_email"
                                ...
                                value="{{ old('personal_email') }}" placeholder="personal@example.com">
                        </div>
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="text" name="emergency_contact" id="emergency_contact"
                                ...
                                value="{{ old('emergency_contact') }}" placeholder="Nombre y teléfono">
                        </div>
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="text" name="residence_address" id="residence_address"
                                ...
                                value="{{ old('residence_address') }}" placeholder="Dirección o barrio">
                        </div>
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="text" name="technical_advisor" id="technical_advisor"
                                ...
                                value="{{ old('technical_advisor') }}" placeholder="Nombre del asesor">
                        </div>
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="text" name="phone" id="phone"
                                ...
                                value="{{ old('phone') }}" placeholder="e.g. 3001234567">
                        </div>
                        @error('phone')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                                ...
                                @foreach($phases as $phase)
                                    <optgroup label="Fase: {{ $phase->name }}">
                                        @foreach($phase->technologists as $tech)
                                            <option value="{{ $tech->id }}" data-phase="{{ $phase->id }}" {{ old('technologist_id') == $tech->id ? 'selected' : '' }}>
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="text" name="fiche_number" id="fiche_number"
                                ...
                                value="{{ old('fiche_number') }}" placeholder="e.g. 2670687">
                        </div>
                        @error('fiche_number')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
