    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <div class="bg-white p-6 rounded-[2rem] shadow-premium border border-slate-100 group hover:shadow-xl transition-all duration-500 overflow-hidden relative">
            ...
            <div class="flex items-center gap-4 mb-4">
                ...
                <div>
                    <p class="text-[10px] font-black text-slate-400 uppercase tracking-widest leading-none mb-1">Esta Semana</p>
                    <h3 class="text-2xl font-black text-slate-800 font-outfit">{{ $stats['weekly_hours'] }}</h3>
                </div>
            </div>
            <div class="w-full bg-slate-100 h-1.5 rounded-full overflow-hidden mb-1">
                <div class="bg-blue-600 h-full transition-all duration-1000" style="width: {{ $weeklyProgress }}%"></div>
            </div>
            <p class="text-[10px] text-slate-400 font-bold uppercase tracking-tighter">{{ $weeklyProgress }}% de la meta semanal (40h)</p>
        </div>
