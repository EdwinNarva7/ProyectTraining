...
class TestUser80Hours2Seeder extends Seeder
{
    /**
    ...
    public function run(): void
    {
        ...
        // Crear segundo usuario de prueba con 80 horas
        $user = User::firstOrCreate(
            ['email' => 'test80h2@example.com'],
            [
                'role_id' => $apprenticeRole->id,
                'full_name' => 'Usuario Prueba 80h #2',
        ...
        // 5 horas = 300 minutos
        $startDate = Carbon::create(2026, 2, 1, 8, 0);
        ...
        $this->command->info("✓ Usuario creado: test80h2@example.com");
